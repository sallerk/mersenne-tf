...
> Design notes, measurements and the mistakes made along the way are in
> [`LESSONS_LEARNED.md`](../LESSONS_LEARNED.md). This file is the manual.
...
```
  *** FACTOR FOUND ***   313603386094415369
      k         = 19007857876   (q = 2kp+1: yes)
      q mod 8   = 1
      size      = 59 bits
...
```python
pow(2, 9147253, 313603386094415369) == 1
```
...
|---|---|
| `2^64 .. 2^65` | ~27 s |
| `2^40 .. 2^65` (everything below, plus that level) | ~50 s |
