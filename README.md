...
| version | |
|---|---|
| [**1.3**](1.3/) | current. The device sieve stopped scaling with the prime count, so it now pays to sieve deep; and 28- and 30-bit limbs removed a 21% cliff above `2^72`. **1.18x** over 1.2 at `2^66`, **1.39x** at `2^76`. Start here — see [1.3/README.md](1.3/README.md). |
