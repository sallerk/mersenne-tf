...
| version | |
|---|---|
| [**1.3**](1.3/) | current. The device sieve stopped scaling with the prime count, so it now pays to sieve deep — 1.19x over 1.2. Start here — see [1.3/README.md](1.3/README.md). |
